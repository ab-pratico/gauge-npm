...
export const options = {
  ...
  GAUGE_BINARY: path.join(basePath, '.gauge/runtime/gauge/gauge'),
  ...
  GAUGE_URL_TEMPLATE_LINUX:
    'https://github.com/getgauge/gauge/releases/download/v%GAUGE_VERSION%/gauge-%GAUGE_VERSION%-linux.%ARCH_STRING%.zip',
};
